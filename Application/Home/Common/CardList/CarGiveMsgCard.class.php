...
"<li class='weui_panel weui_panel_access' style='border-radius: 5px'>
    ...
    <div class='card-container'>
        ...
        <div class='card-content'>
            ...
            <div class='card_item highlight'>车辆类型:{$message['car_type']}</div>
            <div class='card_item highlight collapse'>是否调配:" . $allocate_string . "</div>
            <div class='card_item highlight collapse'>核载吨数:{$message['car_capacity']}</div>
