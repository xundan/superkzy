(function (factory) {
    ...
    CityPicker.prototype = {
        ...
        render: function () {
            ...
            console.log('lastAreaString',this.getLastArea());
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:100%;' +
                    ...
                    '">' +
                    '<div class="city-picker-cancel">X</div>' +
        ...
        bind: function () {
            ...
            $(document).on('click', (this._mouteclick = function (e) {
                ...
                if ((!$input && !$span && !$dropdown) ||
                    ...
                    $this.close(true);
                    console.log($target);
                    if($target.is('.overlay') || $target.is('.city-picker-cancel')){
                        //点阴影区取消搜索
        ...
        getLastArea: function () {
            if (cookie('last_area_select')) {
                console.log('getLastArea_cookie',cookie('last_area_select'));
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        result = data;
                        console.log('getLastAreaSuccess',data);
