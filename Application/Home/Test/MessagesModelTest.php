...
//        $this->assertEquals("61",substr("612345",0,2));
        ...
        $wc2 = \Home\Common\CardList\WhereConditions::parseJson('{"conditions":"[]","page":1,"asc":"record_time desc","exists":["42","35","34","31","30","29","28","27"],"last_count":-1}');
        $this->assertEquals("SELECT * FROM `ck_messages` WHERE ( `invalid_id`=0 AND category='找车' ) AND `id` NOT IN ('42','35','34','31','30','29','28','27') ORDER BY record_time desc LIMIT 0,8  ", $Model->findWhereWithoutExistToSql($wc2, 2, "找车"));
    }
