...
class SellCard extends MsgCard
{
    function toLi()
    {
...
<table class=\"table table-condensed\" style=\"margin: 0\">
    <tbody>
        <tr><td>煤炭种类:{$message['coal_type_name']}</td><td>{$message['price']}元/吨</td></tr>
        <tr><td>煤炭品质:{$message['coal_trait_name']}</td><td>产地:{$message['area_start']}</td></tr>
        <tr><td>煤炭粒度:{$message['coal_granularity']}</td><td>吨数:{$message['quantity']}吨</td></tr>
        <tr><td>有效时间:{$message['deadline']}</td><td>发布时间:{$message['publish_time']}</td></tr>
    </tbody>
</table>
</li>";
