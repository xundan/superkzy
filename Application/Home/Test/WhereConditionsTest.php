...
class WhereConditionsTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testPushSearchCond()
    {
        ...
        $this->assertEquals('{"conditions":"{\"content\":[[\"like\",\"%a%\"],[\"like\",\"%\\\\u4f60\\\\u597d%\"],[\"like\",\"%123%\"],[\"like\",\"%c%\"]]}","page":1,"asc":"record_time desc","exists":[],"last_count":-1}',$whereConditions->toJson());
        $whereConditions->pushCond("id", "eq", "1");
        $whereConditions->pushCond("id", "like", "%0");
        $whereConditions->pushCond("name", "like", "age");
        $this->assertEquals('{"conditions":"{\"content\":[[\"like\",\"%a%\"],[\"like\",\"%\\\\u4f60\\\\u597d%\"],[\"like\",\"%123%\"],[\"like\",\"%c%\"]],\"id\":[[\"eq\",\"1\"],[\"like\",\"%0\"],\"AND\"],\"name\":[\"like\",\"age\"]}","page":1,"asc":"record_time desc","exists":[],"last_count":-1}',$whereConditions->toJson());
        $whereConditions->popCond("content");
        $this->assertEquals('{"conditions":"{\"id\":[[\"eq\",\"1\"],[\"like\",\"%0\"],\"AND\"],\"name\":[\"like\",\"age\"]}","page":1,"asc":"record_time desc","exists":[],"last_count":-1}',$whereConditions->toJson());
